...
export default async function AdminLessonPlanPage({
  ...
  return (
    <AppLayout user={user}>
      <PageHeader
        title="Monitoring Rencana Pelaksanaan Pembelajaran (RPP)"
        subtitle="Supervisi seluruh dokumen RPP guru di sekolah"
      />
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard
            ...
            value={totalReview}
            icon="🔍"
            description="Perlu supervisi admin/kepsek"
          />
        </div>

        {/* Filter Bar */}
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-4">
          <form method="GET" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-8 gap-3">
          ...
          {plansList.length === 0 ? (
            <div className="py-12 text-center text-xs text-zinc-500 space-y-2">
              <p className="font-semibold text-zinc-700 dark:text-zinc-300 text-sm">
                Tidak ada dokumen RPP ditemukan.
              </p>
              <p>Belum ada RPP yang sesuai dengan kriteria filter.</p>
            </div>
          ) : (
