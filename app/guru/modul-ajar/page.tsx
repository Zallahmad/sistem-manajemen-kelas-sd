...
export default async function GuruModulAjarPage({
  searchParams,
}: {
  ...
  return (
    <AppLayout user={user}>
      <PageHeader
        title="Modul Ajar (Perencanaan Pembelajaran)"
        subtitle="Kelola perangkat modul ajar Kurikulum Merdeka per kelas dan mata pelajaran"
        action={
          <Link
            href="/guru/modul-ajar/new"
          ...
          <form method="GET" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-3">
            <div className="lg:col-span-2">
              ...
              <input
                ...
                name="search"
                defaultValue={search || ""}
                placeholder="Cari kata kunci topik..."
          ...
          {modulesList.length === 0 ? (
            <div className="py-12 text-center text-xs text-zinc-500 space-y-2">
              <p className="font-semibold text-zinc-700 dark:text-zinc-300 text-sm">
                Belum ada Modul Ajar ditemukan.
              </p>
              <p>Mulai susun modul ajar kurikulum merdeka pertama Anda sekarang.</p>
              <div className="pt-2">
                <Link
                  href="/guru/modul-ajar/new"
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs text-left">
                <thead className="border-b border-zinc-200 dark:border-zinc-800 text-zinc-500">
                  <tr>
                    <th className="py-2.5 px-3">Judul & Topik Modul</th>
                    ...
                    <tr key={item.id} className="hover:bg-zinc-50/50 dark:hover:bg-zinc-950/30">
                      ...
                      <td className="py-3 px-3 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <Link
                            href={`/guru/modul-ajar/${item.id}/preview`}
